...
class CreditEligibilitySettingController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'credit_limit_90_plus' => 'required|numeric|min:0',
            'credit_limit_80_89' => 'required|numeric|min:0',
            'credit_limit_70_79' => 'required|numeric|min:0',
            'credit_limit_60_69' => 'required|numeric|min:0',
            'credit_limit_50_59' => 'required|numeric|min:0',
            'credit_limit_40_49' => 'required|numeric|min:0',
            'min_account_age_days' => 'required|integer|min:0',
            'min_transaction_count' => 'required|integer|min:0',
            'is_active' => 'boolean',
        ]);
