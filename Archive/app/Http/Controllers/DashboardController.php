...
class DashboardController extends Controller
{
    ...
    public function adminDashboard(Request $request)
    {
        ...
        $apiBalance = $husmodataService->getBalance();
        $virtualAccounts = $husmodataService->getVirtualAccountDetails();
        ...
        $apiDetails = [
            ...
            'virtualAccountError' => !$virtualAccounts['success'] ? $virtualAccounts['message'] : null,
