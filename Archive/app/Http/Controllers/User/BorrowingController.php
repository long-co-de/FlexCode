...
class BorrowingController extends Controller
{
    ...
    /**
     * Disable auto-deduction for a borrowing.
     */
    public function disableAutoDeduction(Request $request, Borrowing $borrowing)
    {
        $user = Auth::user();
        ...
        $borrowing->auto_deduction_enabled = false;
        $borrowing->save();

        return response()->json([
            'success' => true,
            'message' => 'Auto-deduction disabled'
        ]);
    }
