...
class ElectricityController extends Controller
{
    ...
    public function __construct(HusmodataService $husmodataService, VtpassService $vtpass, BorrowingEligibilityService $eligibilityService, WazobiaService $wazobiaService)
    {
    ...
    public function verifyMeter(Request $request)
    {
        ...
        if (!$verify['success']) {
            ...
            $verify = $this->vtpass->verifyCustomer($serviceID, $request->meter_number, 'meter');
        }
    ...
    public function purchase(Request $request)
    {
        ...
        $vt = $this->wazobiaService->payElectricityBill(
            $request->meter_number,
            $request->amount,
            $request->meter_type,
            $user->phone_number
        ...
        if ($vt['success']) {
            ...
            $token = $vt['data']['Token'] ?? ($vt['data']['POWERTOKEN'] ?? null);
