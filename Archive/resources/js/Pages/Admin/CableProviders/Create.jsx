...
export default function CreateCableProvider({ auth }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.cable-providers.store'), {
            onSuccess: () => reset(),
        });
    };
    ...
    return (
        <AdminLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl igg-800 leading-tight">Create Cable Provider</h2>}
        >
            <Head title="Create Cable Provider" />
