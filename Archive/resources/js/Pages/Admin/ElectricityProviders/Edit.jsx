...
export default function EditElectricityProvider({ auth, electricityProvider }) {
    const { data, setData, patch, processing, errors } = useForm({
        name: electricityProvider.name || '',
        code: electricityProvider.code || '',
        logo: null,
        is_active: electricityProvider.is_active,
        _method: 'PATCH',
    });

    const [previewUrl, setPreviewUrl] = useState(electricityProvider.logo || null);
    ...
    const handleSubmit = (e) => {
        ...
        patch(route('admin.electricity-providers.update', electricityProvider.id), formData);
    };
    ...
    return (
        <AdminLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl igg-800 leading-tight">Edit Electricity Provider</h2>}
        >
            <Head title="Edit Electricity Provider" />
