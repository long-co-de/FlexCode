...
export default function CreateNetwork({ auth }) {
    ...
    const handleSubmit = (e) => {
        ...
        post(route('admin.networks.store'), {
            onSuccess: () => reset(),
        });
    };
    ...
    return (
        <AdminLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl igg-800 leading-tight">Create Network</h2>}
        >
            <Head title="Create Network" />
