...
export default function CreateElectricityProvider({ auth }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.electricity-providers.store'), {
            onSuccess: () => reset(),
        });
    };
    ...
    return (
        <AdminLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl igg-800 leading-tight">Create Electricity Provider</h2>}
        >
            <Head title="Create Electricity Provider" />
                        ...
                        <div className="p-6 bg-base-100 border-b border-gray-200">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                    ...
                                    {previewUrl && (
                                        <div className="mt-2">
                                            <p className="text-sm igg-500 mb-1">Preview:</p>
