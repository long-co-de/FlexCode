import { useState, useRef, useEffect } from 'react';import { Head, useForm, usePage } from '@inertiajs/react';
            ...
            <div className="min-h-[80vh] flex flex-col items-center justify-center py-12 px-4">
                <div className="max-w-md w-full">
                    ...
                    <div className="bg-base-100 rounded-[2.5rem] p-8 md:p-10 shadow-2xl shadow-base-300/50 border border-base-300 relative overflow-hidden">
                        ...
                        <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 blur-3xl -mr-16 -mt-16 rounded-full"></div>                    </div>
                </div>
            </div>
        </AppLayout>
    );
